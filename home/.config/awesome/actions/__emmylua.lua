...
--- ### Description
--- This file contains the EmmyLua based annotations for `Keytable` and supporting types, you should not use `require` in this file.

--#region Keytable data
...
--#region Keytable and key combination
