...
globalkeys = gears.table.join(
    ...
    awful.key(
        ...
        { modkey, 'Control' }, 'Right', function() awful.screen.focus_relative(1) end, {
            description = 'focus the next screen',
            group = 'screen',
        }
    ), awful.key(
        { modkey, 'Control' }, 'Left', function() awful.screen.focus_relative(-1) end, {
            description = 'focus the previous screen',
            group = 'screen',
        }
    ), -- Standard program
    ...
    awful.key(
        { modkey }, 'b', function() awful.spawn('google-chrome-stable') end, {
        ...
        function() awful.spawn.with_shell('Xephyr :5 & sleep 1 ; DISPLAY=:5 awesome') end, {
            description = 'test awesome in a new session',
            group = 'launcher',
        }
    ), awful.key(
    ...
    awful.key(
        ...
        { modkey }, 'd', function() awful.util.spawn('rofi -show drun') end, {
...
clientkeys = gears.table.join(
    ...
    awful.key(
        { modkey, 'Mod1' }, 'Right', function(c) c:move_to_screen(c.screen.index + 1) end, {
            description = 'move to next screen',
            group = 'client',
        }
    ), awful.key(
        { modkey, 'Mod1' }, 'Left', function(c) c:move_to_screen(c.screen.index - 1) end, {
