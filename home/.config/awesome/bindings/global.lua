...
local keys = gears.table.join(
    ...
    end, { description = "go back", group = "client" }), -- The same for arrow left and right
    ...
    awful.key({ modkey, "Control", "Mod1" }, "r", function()
    ...
    awful.key({ modkey, "Control", "Shift", "Mod1" }, "l", function()
